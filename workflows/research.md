<purpose>
Điều phối pipeline nghiên cứu: route query -> spawn Evidence Collector -> spawn Fact Checker. 2 agents chạy tuần tự. Output Collector là input Checker.
</purpose>

<required_reading>
Đọc trước khi bắt đầu:
- @references/conventions.md -> quy tắc output tiếng Việt, commit prefix
</required_reading>
