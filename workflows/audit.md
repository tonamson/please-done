...
- @references/security-checklist.md -> security checklist — WHEN audit involves manual security checks
- @references/conventions.md -> commit conventions, icons — WHEN creating reports or committing audit results
</conditional_reading>
