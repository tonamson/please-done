<purpose>
Check closed bugs, create summary report, commit, create git tag, update tracking files, transition to next milestone.
</purpose>
...
4. Not found or needs verification → 4 levels (see @references/verification.md):
...
- Reports + CHANGELOG written product-oriented (see @references/ui-brand.md)
</rules>
