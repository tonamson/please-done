...
- **Has code:** `fastcode/code_qa`: patterns in use, reusable functions
FastCode error → search/read fallback. Warning: "FastCode error — using built-in. Run `/pd:init` to check."
...
- FastCode error → search/read fallback, log warning
**Deviation rules:**
