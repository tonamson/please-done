...
Get list of 13 valid slugs via execute:
```bash
...
No flag → run smart selection (this entire step does NOT spawn AI — only execute/glob/search):
1. **Gather project context:**
   ...
   d. search code patterns (3-4 grouped commands):
...
4. agent pd-sec-scanner uses FastCode tool-first, search fallback (per D-14 Phase 46)
