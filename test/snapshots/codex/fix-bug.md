...
- description: mo ta loi tu user ({{GSD_ARGS}} hoac input)
...
- Co {{GSD_ARGS}} du trieu chung -> WARNING: "Janitor khong phan hoi. Tiep tuc voi thong tin ban dau."
  Tao evidence_janitor.md thu cong tu {{GSD_ARGS}} (5 trieu chung theo format evidence), tiep Buoc 2.
