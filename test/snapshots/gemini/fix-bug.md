...
fix-bug không đọc từ TASKS.md effort. Effort suy ra từ phân loại rủi ro:
| Phân loại bug | Effort | Model |
|---------------|--------|-------|
| 🟢 Sửa nhanh | simple | haiku |
| 🟡 Lỗi logic | standard | sonnet |
| 🟠 Lỗi dữ liệu | standard | sonnet |
| 🔴 Bảo mật | complex | opus |
| 🔵 Hạ tầng | simple | haiku |
Thông báo: "Spawning {model} agent cho fix-bug ({effort} — {phân_loại})..."
### 6b. Đánh giá kết quả
