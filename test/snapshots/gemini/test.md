...
- FastCode MCP lỗi → Fallback search_file_content/read_file. Warning: "FastCode MCP lỗi — dùng built-in tools. Chạy `/pd:init` kiểm tra lại."
...
- FastCode MCP lỗi → fallback search_file_content/read_file, ghi warning gợi ý `/pd:init`
