...
---
<objective>
Tải tài liệu từ URL -> markdown local kèm version + mục lục phân section. Cache đúng version, skill sau chỉ đọc mục lục rồi read_file section cần thiết.
</objective>
<guards>
...
- [ ] web_fetch tool kha dung -> "web_fetch khong kha dung. Kiem tra cai dat MCP."
</guards>
<context>
...
- Xếp hạng tối đa 10 trang -> fetch 5 đầu (nhiều web_fetch cùng 1 block)
...
**Loi thuong gap:**
- web_fetch khong kha dung -> kiem tra MCP
