...
describe('ensureDir', () => {
  ...
  it('throw khi dir la empty string', () => {
    assert.throws(() => ensureDir(''), /dir phai la string khong rong/);
  });

  it('throw khi dir la null', () => {
    assert.throws(() => ensureDir(null), /dir phai la string khong rong/);
  });
});
...
describe('copyWithBackup', () => {
  ...
  it('throw khi file nguon khong ton tai', () => {
    assert.throws(() => copyWithBackup('/nonexistent', '/tmp/x'), /file nguon khong ton tai/);
  });
});
...
describe('cleanOldFiles', () => {
  ...
  it('tra ve 0 khi thu muc khong ton tai', () => {
    assert.strictEqual(cleanOldFiles('/nonexistent-pd', () => true), 0);
  });
});
