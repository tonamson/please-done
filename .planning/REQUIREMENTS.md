...
- [ ] **TOKN-03**: Conditional context loading — chỉ load references/rules khi task type cần, không dump hết upfront
- [ ] **TOKN-04**: Effort-level routing — dùng model nhỏ hơn cho task đơn giản, Opus chỉ cho planning/complex
...
| TOKN-03 | Phase 4: Conditional Context Loading | Pending |
| TOKN-04 | Phase 5: Effort-Level Routing | Pending |
