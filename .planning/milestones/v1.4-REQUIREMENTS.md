# Requirements Archive: v1.4 Mermaid Diagrams
...
- [x] **INTG-01**: Workflow complete-milestone tu dong goi buoc ve so do va tao bao cao quan ly
- [x] **INTG-02**: Buoc ve so do la non-blocking — milestone completion khong bi fail neu PDF generation loi
