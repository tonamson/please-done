...
|----------|-------------|---------------|-------|-------|-----------|
| Codex CLI | 90 | 26 | 26 | 6,602 | ✅ 0 |
| GitHub Copilot | 112 | 26 | 26 | 6,243 | ✅ 0 |
| Gemini CLI | 37 | 6 | 26 | 1,257 | ✅ 0 |
| OpenCode | 33 | 7 | 25 | 6,337 | ✅ 0 |

**Total**: 103 files, 20,439 lines generated for 4 platforms from 1 single source.
...
| Component | Count |
|-----------|-------|
| Skills (user-invoked commands) | 16 |
| Workflows (detailed processes) | 14 |
| Total workflow steps | 126 |
| Check gates (STOP/BLOCK) | 75 |
| Recovery points (interruption) | 39 |
| User interaction points | 39 |
| Templates (file templates) | 12 |
| References (shared conventions) | 13 |
| Rules (stack-specific code rules) | 8 |
| Total workflow lines | 3,885 |
...
---
*Benchmark auto-generated by `node test/benchmark.js` — 2026-04-04T05:39:24.629Z*
