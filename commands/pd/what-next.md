...
5. **Đọc TEST_REPORT** (CHỈ nếu project có Backend NestJS, WordPress, Solidity, hoặc Flutter trong CONTEXT.md) → `.planning/milestones/[version]/phase-[phase]/TEST_REPORT.md` tồn tại?
...
CHỈ áp dụng khi project có (Backend NestJS HOẶC WordPress HOẶC Solidity HOẶC Flutter) VÀ (chưa có TEST_REPORT HOẶC TEST_REPORT có tests fail).
