...
4. Tổng hợp thành file tóm tắt triệu chứng:
   - File: `.planning/debug/evidence_janitor_[tên-tắt].md` (Tên-tắt: viết thường, gạch ngang, VD: `login-fail`).
   - Nội dung: Chứa 5 triệu chứng và mục `## RELATED HISTORICAL BUGS` (nếu có).
</process>
